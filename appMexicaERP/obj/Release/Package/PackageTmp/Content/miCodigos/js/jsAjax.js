function dialogoAjax(idDialogo, anchoDialogo, modal, title, position, data, url, method, preFunction, postFunction, cache, async) {
    ...
    $.ajax(
    {
        ...
        $('#divModalCargaAjax').hide();
        $('#' + idDialogo).html('<div class="divAlertaRojo">Ocurrió un error inesperado. Por favor reporte esto a la plataforma o al correo "ovallesoft@gmail.com". Pedimos disculpas y damos gracias por su comprensión.</div>');
    });
